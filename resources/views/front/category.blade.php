...
<head>
  ...
  <title>IndNews</title>
  <link rel="icon" type="image/png" sizes="32x32" href="{{asset('assets/images/logos/favicon/favicon-32x32.png')}}" />
  ...
  <nav id="Navbar" class="max-w-[1130px] mx-auto flex justify-between items-center mt-[30px]">
    <div class="logo-container flex gap-[30px] items-center">
      <a href="/" class="flex shrink-0">
        <img class="w-12 h-12" src="{{asset('assets/images/logos/logo-indnews.svg')}}" alt="logo" />
      </a>
  ...
  <section id="Category-result" class="max-w-[1130px] mx-auto flex items-center flex-col gap-[30px] mt-[70px]">
    ...
    <div id="search-cards" class="grid grid-cols-3 gap-[30px]">
      ...
      <div class="col-span-3 text-center">
        <p class="text-lg font-semibold text-gray-500">Belum ada berita dalam kategori ini.</p>
      </div>
      @endforelse
